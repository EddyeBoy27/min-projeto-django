...
class Apedido(models.Model):
    ...
    apedidata = models.DateField()
    apedistatus = models.SmallIntegerField()
    apedivenc = models.DateField()
...
class Aproduto(models.Model):
    ...
    aprodnome = models.CharField(max_length=255)
    aprodvalor = models.DecimalField(max_digits=10, decimal_places=2)
    aprodqntd = models.IntegerField()
    aprodativo = models.SmallIntegerField()
